...
.. _sql-examples-for-recipient-lists:

=============================================================
SQL examples for Recipient Lists
=============================================================
...
======================================  ================  ============== =============== =============
:code:`###EMAIL###`                          yes               yes              yes      replaced by the escaped recipient email address
:code:`###BOUNCE_TYPE###`                    yes                                         replaced by the bounce type
:code:`###BOUNCE_TYPE_SOFT###`               yes                                         constant for soft bounce
:code:`###BOUNCE_TYPE_HARD###`               yes                                         constant for hard bounce
:code:`###BOUNCE_TYPE_UNSUBSCRIBE###`        yes                                         constant for unsubscribe bounce
======================================  ================  ============== =============== =============
